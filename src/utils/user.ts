export class user {
    ...
    constructor(username:string | undefined, password:string | undefined, firstName:string, lastName:string) {
        ...
        if (firstName.length == 0){
            throw new Error("customer: A variável firstName deve ter ao menos um caractere");
        }

        if (lastName.length == 0){
            throw new Error("customer: A variável password deve ter ao menos um caractere");
        }
